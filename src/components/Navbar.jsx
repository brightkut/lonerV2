...
import { FaMoon, FaSun, FaCat } from "react-icons/fa";
...
const Navbar = () => {
    ...
    return (
        <header className='header'>
            <NavLink to='/' className="w-20 h-10 rounded-lg items-center justify-center flex font-bold">
                <div className="text-blue-500 dark:text-yellow-500 mx-2">
                    <FaCat />
                </div>
