    ...
    return(
        ...
        <section className="max-container">
            ...
            <div className="mt-5 text-slate-500 dark:text-slate-300">
                ...
                Hello! I’m <span
                className="text-blue-500 dark:text-yellow-400 font-semibold drop-shadow">Bright 🇹🇭</span>, a software
                ...
                Don’t hesitate to challenge me to a match! I believe in hard work more than in talent; it’s all about
            ...
            <div className='mt-5 flex flex-col gap-3 text-slate-500 dark:text-slate-300'>
                <p>
                    I’ve partnered with different companies, growing my expertise and learning from brilliant teammates.
